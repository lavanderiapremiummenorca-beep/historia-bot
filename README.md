# 🤖 Historia en Breve — Shorts automaticos y gratis

Genera y publica un Short de historia y curiosidades al dia en YouTube, en automatico y sin pagar suscripciones.

- **Voz:** edge-tts (neuronal, gratis) en GitHub Actions · voz configurada: `es-ES-AlvaroNeural`
...
3. El workflow `.github/workflows/daily.yml` hace las dos cosas cada dia (~10:13 Espana).
...
- `YT_CLIENT_SECRET`
- `YT_REFRESH_TOKEN`
- `CHANNEL_HANDLE` — tu @handle para la marca de agua (ej. `@HistoriaEnBreve`)
